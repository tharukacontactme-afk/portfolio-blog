/** Extensions tried when loading logos from public/images/brands/ */
...
export function brandLogoCandidates(logo: string): string[] {
  return publicImageCandidates('brands', logo)
}
